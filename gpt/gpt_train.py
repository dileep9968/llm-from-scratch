...
def evaaluate_model(model, train_loader, val_loader, device, eval_iter):
    model.eval()
    with torch.no_grad():
...
def train_model_simple(model, train_loader, val_loader, optimizer, device, num_epochs, eval_freq, eval_iter, start_context, tokenizer):
    ...
    # Initilize lists to track losses and tokens seen
    ...
    for epoch in range(num_epochs):
        ...
        for input_batch, target_batch in train_loader:
            ...
            loss = calc_loss_batch(input_batch, target_batch, model, device) #reset loss gradient from previous batch iteration
            ...
            if global_step % eval_freq ==0:
                train_loss, val_loss = evaaluate_model(
